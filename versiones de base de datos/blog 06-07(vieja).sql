...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2017 a las 00:56:38
...
INSERT INTO `calificacion_favores` (`id_favor`, `mailUsuario`, `mailAceptado`, `calificacionObtenida`, `comentarios`) VALUES
(36, 'Ulises@hotmail.com', 'jmvarela-@hotmail.com', 1, 'Todo piola'),
(41, 'franco@unlp.com', 'jmvarela-@hotmail.com', 1, 'Muy bien todo'),
(40, 'juanman@hotmail.com', 'franco@unlp.com', -1, 'no me gusto');
...
(40, 'Necesito alguna persona que pasee mi perra', 'Tengo que pasear a mi perro y no tengo tiempo, se porta bien.', 'Cuidados', 'Tucumán', 'juanman@hotmail.com', 'franco@unlp.com', '2017-10-13'),
(41, 'Holaaaaaaaaaaa', 'como anda? asdasd\r\n', 'Viajes', 'Puerto Madryn', 'franco@unlp.com', 'jmvarela-@hotmail.com', '2017-06-30');
...
('Franco', 'franco@unlp.com', '123456', -2, 9, '1234567890', '02/06/2017', 'Gauchada.png', 0),
('Juan Manuel', 'jmvarela-@hotmail.com', '654321', 2, 11, '2215563511', '11/01/1990', '12.jpg', 0),
...
--
ALTER TABLE `favor`
  MODIFY `favorId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
--
...
--
ALTER TABLE `postulantes`
  MODIFY `postulantId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
