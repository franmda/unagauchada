...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-06-2017 a las 06:27:26
...
('Francisco Lucchetta', 'fllk06_mda@hotmail.com', '123456', 0, 19996, 'Observador', '66', '2017-05-20', 'Gauchada.png', 0),
('ulises netramonti', 'fllk06_mda@hotmail.edu', '123456', 0, 0, 'Observador', '4545454545', '', 'Gauchada.png', 0),
...
--
ALTER TABLE `imagenes`
  MODIFY `idImagen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
-- AUTO_INCREMENT de la tabla `postulantes`
--
ALTER TABLE `postulantes`
  MODIFY `postulantId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
-- AUTO_INCREMENT de la tabla `registro_ganancias`
--
ALTER TABLE `registro_ganancias`
  MODIFY `id_registro` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
